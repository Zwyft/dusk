...
set(CMAKE_C_FLAGS
    "${CMAKE_C_FLAGS} -g -Wall -O2 -ffunction-sections ${DUSK_SWITCH_ARCH_FLAGS}"
    CACHE STRING "C flags for experimental Switch builds" FORCE)
set(CMAKE_CXX_FLAGS
    "${CMAKE_CXX_FLAGS} ${CMAKE_C_FLAGS} -fno-rtti -fno-exceptions"
    CACHE STRING "CXX flags for experimental Switch builds" FORCE)
set(CMAKE_ASM_FLAGS
    "${CMAKE_ASM_FLAGS} -g ${DUSK_SWITCH_ARCH_FLAGS}"
